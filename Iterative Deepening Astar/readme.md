...
## cmd format : 
> python TaskExecution.py  ida  [Testcase Number] [Test Case Sequence]

### Test Case 1  => Result_test1.txt
> python TaskExecution.py ida 1 1,2,5,3,4,0,6,7,8

### Test Case 2 => Result_test2.txt
> python TaskExecution.py ida 2 3,1,2,0,4,5,6,7,8

### Test Case 3 => Result_test3.txt
> python TaskExecution.py ida 3 3,1,2,4,5,0,6,7,8

### Test Case 4 => Result_test4.txt
> python TaskExecution.py ida 4 1,2,5,0,3,4,6,7,8
